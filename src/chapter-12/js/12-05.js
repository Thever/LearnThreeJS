...
function createLeftFlipper(scene, mat) {
  ...
  //  添加旋转约束,参数:被约束对象，约束对象，约束应用的点位置，旋转的角度
  ...
  constraint.setLimits(
          -2.2, // 最小弧度，minimum angle of motion, in radians, from the point object 1 starts (going back)
          -0.6, // 最大弧度，maximum angle of motion, in radians, from the point object 1 starts (going forward)
          0.3, // 在错误位置修正速度，applied as a factor to constraint error, how big the kantelpunt is moved when a constraint is hit
          0.5 // 变化速度，controls bounce at limit (0.0 == no bounce)
  );
